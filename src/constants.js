...
export const dialogueData = {
    "cs-degree": [`
        En el año 2000 inicié los estudios en la diplomatura de informática de sistemas, pero por cuestiones personales no los finalicé.<br/> 
        En 2004 obtuve mi título de ciclo de grado superior en sistemas de telecomunicaciones e informáticos, donde monté mi primera web en Dreamweaver.<br/>
        Desde 2008 llevo formandome en tecnologías web en las empresas en las que me he desarrollado y también de manera autodidacta haciendo cursos, tutoriales, proyectos personales, etc.<br/>
        La formación continua es algo que me motiva, dispuesto a aprender cosas nuevas y compartir lo aprendido.
    `],
    "extra-info": [`
        * <strong>Email:</strong> <a href="mailto:edgarmorerasantana@gmail.com" target="_blank">edgarmorerasantana@</a><br/>
        * <strong>Github:</strong> <a href="https://github.com/edgar-morera" target="_blank">edgar-morera</a><br/>
        * <strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/edgar-morera-santana" target="_blank">edgar-morera-santana</a><br/>
        * <a href="cv_edgar_morera.pdf" download="cv_edgar_morera.pdf">CV en PDF</a><br/>
    `],
    tv: [`
        En mi tiempo libre me gusta:<br/><br/>
        &nbsp;* &#128111; Disfrutar de mi gente<br/>
        &nbsp;* &#127928; Tocar canciones en la guitarra.<br/>
        &nbsp;* &#128692; Salir con mi bici.<br/>
        &nbsp;* &#127836; Disfrutar de la cocina.<br/>
        &nbsp;* &#127902; Ver alguna peli, serie o documental.<br/>
        &nbsp;* &#128187; Leer/aprender sobre tecnología.<br/>
        &nbsp;* &#128576; Y nunca digo que no a una partida de exploding kittens.<br/>
    `],
    ...
    exit: [`Si quieres salir de <strong>Edgar CV · The Great Adventure</strong> solo tienes que cerrar la pestaña.`],
    "npc-info": [`Bienvenido a <strong>Edgar's CV · The Great Adventure</strong><br/>
        Para moverte, pincha y manten pulsado hacia donde quiere ir. <br/>
        Algunos objetos, al acercarte, mostraran la información más importante para poder continuar con nuestra aventura.<br/><br/>
        Mucha suerte y espero que disfrutes de la aventura.`],
};